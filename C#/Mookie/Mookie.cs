...
class Mookie
{
    ...
    static string GetResponse(string userMessage)
    {
        ...
        List<string> i_am_fine = new List<string>
        {
        ...
        if (userMessage.Contains("i am fine", StringComparison.OrdinalIgnoreCase) ||
            userMessage.Contains("doing great", StringComparison.OrdinalIgnoreCase) ||
            userMessage.Contains("been great", StringComparison.OrdinalIgnoreCase))
        {
            Random random = new Random();
            int index = random.Next(i_am_fine.Count);
            return i_am_fine[index];
        }
